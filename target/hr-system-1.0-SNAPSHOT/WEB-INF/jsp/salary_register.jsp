    ...
    <form class="form-panel" id="registerForm" action="javascript:void(0)">
        <ul class="flex_ul" >
            <li class="flex_li">
                ...
                <input disabled="true" class="form-control" value="1000000000003" type="text" name="salaryStandardId">
            </li>
            <li class="flex_li">
                <span class="form_text">薪酬标准名称</span>
                <input class="form-control" type="text" name="salaryStandardName">
            </li>
            <li class="flex_li">
                <span class="form_text">薪酬总额</span>
                <input disabled="true" class="form-control" type="text" name="totalSalary">
            </li>
            <li class="flex_li">
            ...
            <li class="flex_li">
                ...
                <input  class="form-control" type="text" name="registrant" value="<security:authentication property="principal.username"></security:authentication>">
            </li>
            <li class="flex_li">
                <span class="form_text">登记时间</span>
                <input type="text" disabled="true" class="form-control" id="registerTime" name="registerTime" >
            </li>
            <li class="flex_li">
                <div class="submitBtn">
                    ...
                    <div class="span12 offset3 doc-content">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr class="active">
                                <td>1</td>
                                <td>基本工资</td>
                                <td><input onkeyup="calculateInsurance(this)" class="form-control" type="text" name="baseSalary"></td>
                            </tr>
                            <tr class="active">
                                <td>2</td>
                                <td>交通补助</td>
                                <td><input onkeyup="calculateTotal(this)" class="form-control" type="text" name="travelAllowance"></td>
                            </tr>
                            <tr class="active">
                                <td>3</td>
                                <td>午餐补助</td>
                                <td><input onkeyup="calculateTotal(this)" class="form-control" type="text" name="lunchAllowance"></td>
                            </tr>
                            <tr class="active">
                                <td>4</td>
                                <td>通信补助</td>
                                <td><input onkeyup="calculateTotal(this)" class="form-control" type="text" name="communicationAllowance"></td>
                            </tr>
                            <tr class="active">
                                <td>5</td>
                                <td>养老保险</td>
                                <td><input class="form-control" disabled="true" type="text" name="endowmentInsurance" value="0.00"></td>
                            </tr>
                            <tr class="active">
                                <td>6</td>
                                <td>失业保险</td>
                                <td><input class="form-control" disabled="true" type="text" name="unemploymentInsurance" value="0.00"></td>
                            </tr>
                            <tr class="active">
                                <td>7</td>
                                <td>医疗保险</td>
                                <td><input class="form-control" disabled="true" type="text" name="medicalInsurance" value="0.00"></td>
                            </tr>
                            <tr class="active">
                                <td>8</td>
                                <td>住房公积金</td>
                                <td><input class="form-control" disabled="true" type="text" name="housingFund" value="0.00"></td>
                            </tr>
...
<script>
    $(function () {
        $("input[name='salaryStandardId']").val(Math.floor((Math.random()+Math.floor(Math.random()*9+1))*Math.pow(10,11)));
        $("#registerForm").submit(function () {
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/salary/standard",
                data: $("#registerForm").serialize(),
                dataType: "json",
                success: function(data){
                    var message = "薪酬标准提交成功！等待薪酬经理复核。";
                    var back = "${pageContext.request.contextPath}/salary/standard/register/salary_register";//信息提示页面的返回url
                ...
                error: function (data) {
                    var message = "薪酬标准添加失败，请稍后重试！";
                    var back = "${pageContext.request.contextPath}/salary/standard/register/salary_register";
    ...
    function calculateInsurance(obj){
        ...
        if (!isNaN(num) && num!=""){
            ...
            $("input[name='medicalInsurance']").val((num*0.02+10).toFixed(2));
